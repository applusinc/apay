      ...
      body: SafeArea(
        ...
        children: [
          ...
          const Padding(
            ...
            child: Text.rich(textAlign: TextAlign.center, TextSpan(children: <InlineSpan>[
              TextSpan(
                
                text: 'Devam ederek ',
                style: TextStyle( fontFamily: 'averta',fontSize: 12,  color: Colors.white60),
              ),
              TextSpan(
                
                text: 'Kullanıcı Sözleşmesi',
                style: TextStyle( fontFamily: 'averta',fontSize: 12,  color: Colors.white),
              ),
              TextSpan(
                text: ' ve ',
                style: TextStyle( fontFamily: 'averta',fontSize: 12,  color: Colors.white60),
